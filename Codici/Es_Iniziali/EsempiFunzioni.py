...
print("Somma di", valore1, "e", valore2, "=", risultato_somma)
...
risultato2 = moltiplica(moltiplica(3,3) , moltiplica(3,3))
risultato3=moltiplica(9,9)
risultato2 = moltiplica( moltiplica(2,5) , moltiplica(2,5))
risultato3 = (10,10)
